        ...
        <div class="p-6">
           ...
           <form id="student-table-form" class="rounded-lg" method="POST">
               <table id="student-table" class="min-w-full bg-white border drop-shadow-md border-gray-300 rounded-lg">
                   <thead>
                       <tr>
                           <th class="border bg-gray-700 text-white px-2 py-2">No</th>
                           <th class="border bg-gray-700 text-white px-4 py-2">Enrollment no.</th>
                           <th class="border bg-gray-700 text-white px-4 py-2">Student Name</th>
                           <th class="border bg-gray-700 text-white px-4 py-2">Registered on</th>
                           <th class="border bg-gray-700 text-white px-4 py-2">Round Status</th>
                           <th class="border bg-gray-700 text-white px-4 py-2">Round Action</th>
                       </tr>
                   </thead>
                   <tbody>
                       <?php
